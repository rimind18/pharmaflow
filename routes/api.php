...
Route::prefix('v1')->group(function () {
    ...
    Route::post('webhook/midtrans', [PaymentController::class, 'notification']);
    ...
    Route::middleware('jwt')->group(function () {
        ...
        Route::get('stocks/check-expired', [StockMonitoringController::class, 'checkExpiringMedicine']);
        ...
        Route::middleware('role:staff')->group(function () {
            Route::post('payments/cod/confirm', [PaymentController::class, 'confirmCOD']);
            Route::post('transactions/calculate-change', [TransactionController::class, 'calculateChange']);
            ...
            Route::get('medicines/search/{code}', [MedicineController::class, 'searchByCode']);
            ...
            Route::get('stocks/expired', [StockController::class, 'expired']);
            Route::get('stocks/expiring-soon', [StockController::class, 'expiringSoon']);
            ...
            Route::get('employees/{id}/attendance-report', [EmployeeController::class, 'attendanceReport']);
            ...
            Route::get('cashflow/by-category', [CashflowController::class, 'byCategory']);
            Route::get('cashflow/daily-trend', [CashflowController::class, 'dailyTrend']);
            Route::get('cashflow/top-categories', [CashflowController::class, 'topCategories']);
...
// ============================================
        ...
        Route::middleware('role:owner')->group(function () {
            ...
            Route::get('owner/orders', [OrderController::class, 'index']);
            Route::get('dashboard/summary', [DashboardController::class, 'summary']);
            Route::post('payments/cod/confirm', [PaymentController::class, 'confirmCOD']);
            ...
            Route::get('dashboard/warnings', [DashboardController::class, 'warnings']);
            Route::get('/dashboard/reorder-recommendation', [DashboardController::class, 'reorderRecommendation']);
            Route::get('dashboard/analytics-owner', [DashboardController::class, 'analyticsOwner']);
            
            Route::post('/purchases/generate-from-recommendation', [PurchaseController::class, 'generateFromRecommendation']);
            Route::post('/purchases/{id}/approve', [PurchaseController::class, 'approve']);
            Route::post('/purchases/{id}/ordered', [PurchaseController::class, 'markOrdered']);

            Route::get('reports/financial', [DashboardController::class, 'financialReport']);
            Route::get('reports/cashflow', [DashboardController::class, 'cashflowReport']);
            Route::get('reports/product-performance', [DashboardController::class, 'productPerformance']);
            Route::get('reports/audit-logs', [AuditLogReportController::class, 'index']);
            ...
            Route::get('reports/profit-products/export', [ProfitAnalysisController::class, 'export']);
            Route::get('dashboard/executive', [DashboardController::class, 'executive']);
            Route::get('reports/inventory-valuation', [DashboardController::class, 'inventoryValuation']);
            Route::get('reports/inventory-valuation/export', [DashboardController::class, 'exportInventoryValuation']);
            Route::get('reports/financial/export', [DashboardController::class, 'exportFinancialReport']);
            ...
            Route::get('reports/cash-flow-statement', [CashFlowStatementController::class, 'index']);
            Route::get('dashboard/owner-financial', [OwnerFinancialDashboardController::class, 'index']);
            Route::get('dashboard/owner-analytics', [OwnerAnalyticsController::class, 'index']);
            Route::get('dashboard/inventory-intelligence', [InventoryIntelligenceController::class, 'index']);
            Route::get('/dashboard/owner-analytics-v2', [AdvancedOwnerAnalyticsV2Controller::class, 'index']);
            Route::post('/notifications/generate', [NotificationController::class, 'generate']);
            Route::get('/notifications/dashboard', [NotificationDashboardController::class, 'index']);
            ...
            Route::prefix('stock-opname')->group(function () {
                ...
                Route::post('/{id}/reject', [StockOpnameController::class, 'reject']);
            });
        });
    });
});