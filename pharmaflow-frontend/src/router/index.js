...
const routes = [
...

    {
        path: "/order-success",
        name: "OrderSuccess",
        component: () => import("@/pages/customer/OrderSuccess.vue"),
        meta: { requiresAuth: false },
    },

    {
        path: "/order-tracking",
        name: "OrderTracking",
        component: () => import("@/pages/customer/OrderTracking.vue"),
        meta: { requiresAuth: false },
    },
...

    {
        ...
        children: [
...

            {
                path: "transactions",
                name: "Transactions",
                component: () => import("@/pages/staff/Transactions.vue"),
            },
            ...
            // Inventory
            {
                path: "medicines",
                name: "Medicines",
                component: () => import("@/pages/staff/Medicines.vue"),
            },

            {
                path: "categories",
                name: "Categories",
                component: () => import("@/pages/staff/Categories.vue"),
            },

            {
                path: "suppliers",
                name: "Suppliers",
                component: () => import("@/pages/staff/Suppliers.vue"),
            },

            {
                path: "warehouses",
                name: "Warehouses",
                component: () => import("@/pages/staff/Warehouses.vue"),
            },

            {
                path: "shelves",
                name: "Shelves",
                component: () => import("@/pages/staff/Shelves.vue"),
            },

            {
                path: "stocks",
                name: "Stocks",
                component: () => import("@/pages/staff/Stocks.vue"),
            },
...

            {
                ...
                component: () => import("@/pages/staff/Notifications.vue"),
            },
            ...
            // Reports
            {
                ...
                name: "SalesReport",
                component: () =>
                    import("@/pages/staff/Reports/SalesReport.vue"),
            },

            {
                ...
                name: "ProfitReport",
                component: () =>
                    import("@/pages/staff/Reports/ProfitReport.vue"),
            },

            {
                ...
                component: () =>
                    import("@/pages/staff/Reports/InventoryReport.vue"),
            },
        ],
    },
    ...
    // ========================================
    {
        ...
        children: [
...

            {
                path: "analytics",
                name: "Analytics",
                component: () => import("@/pages/owner/Analytics.vue"),
            },
...

            {
                path: "stocks",
                name: "OwnerStocks",
                component: () => import("@/pages/owner/Management/Stocks.vue"),
            },
...

            {
                ...
                component: () => import("@/pages/owner/Notifications.vue"),
            },
        ],
    },
...
router.beforeEach(async (to) => {
    ...
    if (roleNeeded) {
        ...
        const allowedRoles = Array.isArray(roleNeeded)
            ? roleNeeded
            : [roleNeeded];
