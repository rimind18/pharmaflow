<template>
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-5">
            ...
            <div class="bg-white rounded-3xl border border-slate-200 p-6">
                <p class="text-slate-500 text-sm">Supplier Aktif</p>
            ...
            <div class="bg-white rounded-3xl border border-slate-200 p-6">
                <p class="text-slate-500 text-sm">Supplier Nonaktif</p>
...
const totalMedicines = computed(() =>
    suppliers.value.reduce((sum, s) => sum + Number(s.medicines_count || 0), 0),
);
const fetchSuppliers = async () => {
    ...
    try {
        ...
        if (filterStatus.value !== "") {
            params.is_active = filterStatus.value === "aktif";
        }
...
const saveSupplier = async () => {
    ...
    try {
        ...
        ElMessage.error(
            error.response?.data?.message || "Gagal menyimpan supplier",
        );
    } finally {
